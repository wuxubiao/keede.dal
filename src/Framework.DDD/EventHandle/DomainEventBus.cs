...
namespace Framework.DDD.EventHandle
{
    ...
    {
        public delegate void DistributeException(IDomainEventSubscriber subscriber, IDomainEvent domainEvent, Exception exception);
        /// <summary>
        ...
        public event DistributeException DistributeExceptionEvent;
        ...
        public void Distribute(IDomainEventSubscriber subscriber, IDomainEvent domainEvent)
        {
            try
            {
